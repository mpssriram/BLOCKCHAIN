...
/** Opens Web3Auth login modal only; returns wallet address. Use when user clicks "Connect Wallet". */
export async function connectWalletOnly(): Promise<string> {
  ...
  signer = s;
  payrollContract = null; // not connecting to contract in this flow
